    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='avatar.png', null=True, upload_to=base.models.avatar_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_size', models.CharField(choices=[('X', 'X'), ('XL', 'XL')], max_length=3)),
                ('item_color', models.CharField(choices=[('Red', 'Red'), ('Black', 'Black')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_addres', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='billing_addres', to='base.address')),
                ('coupon', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.coupon')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.customer')),
                ('shipping_addres', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shipping_addres', to='base.address')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
